...
## 💻 Languages and Tools
<p align="left">
  <img src="https://skillicons.dev/icons?i=aws,azure,bash,cpp,cs,python,java,javascript,nodejs,php,go,rust,mysql,postgresql,mongodb,sqlite,redis,git,linux,docker,kubernetes,terraform,grafana,prometheus,jenkins,figma,tailwind&perline=10" />
</p>
